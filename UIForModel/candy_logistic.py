#In task 3, you were required to build a logistic regression model and show the accuracy on Streamlit UI. The following code displays the dataset, heatmap, and accuracy of the model.
